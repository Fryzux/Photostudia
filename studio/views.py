...
class HallViewSet(viewsets.ModelViewSet):
    ...
    CRUD for /api/halls/
    """
    queryset = HallRepository.get_all()
    ...
    def availability(self, request, pk=None):
        ...
        # Use Repository (Task 10)
        from datetime import time as time_obj, datetime as dt_obj
        from django.utils.timezone import make_aware
        day_start = make_aware(dt_obj.combine(target_date, time_obj.min))
        day_end = make_aware(dt_obj.combine(target_date, time_obj.max))
        
        bookings = BookingRepository.get_overlapping_bookings(hall, day_start, day_end).order_by('start_time')
...
class BookingViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        # Trigger background task - MOVED TO SERVICE LAYER PER REQUIREMENT #7
...
class OrderListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        return OrderRepository.filter_by_user(self.request.user).select_related('booking__hall')
